      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-4">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-3 sm:mb-4 px-2 text-foreground dark:text-white leading-tight tracking-tight">
            {t("tools.title.before")}<span className="relative inline-block">
              <span className="bg-gradient-to-r from-[hsl(var(--brand-blue))] via-[hsl(var(--brand-blue))] to-[hsl(var(--brand-blue))] bg-clip-text text-transparent bg-[length:200%_100%]">{t("tools.title.highlight")}</span>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl font-bold text-foreground dark:text-white mb-3 sm:mb-4 relative z-10">
              <span className="bg-gradient-to-r from-[hsl(var(--brand-blue))] to-[hsl(var(--brand-blue))] bg-clip-text text-transparent">{t("tools.adapt.title")}</span>
            </p>
